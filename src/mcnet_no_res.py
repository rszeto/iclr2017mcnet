...
class MCNET_NO_RES(object):
  ...
  def forward(self, diff_in, xt, cell):
    ...
    for t in xrange(self.T):
      if t == 0:
        ...
        x_hat = self.dec_cnn(h_tp1, reuse=False)
      else:
        ...
        x_hat = self.dec_cnn(h_tp1, reuse=True)
  ...
  def dec_cnn(self, h_comb, reuse=False):
    ...
    deconv3_3 = relu(deconv2d(relu(depool3),
    ...
    deconv2_2 = relu(deconv2d(relu(depool2),
    ...
    deconv1_2 = relu(deconv2d(relu(depool1),
